...
class JoinDialog(QtGui.QDialog):
	...
	def getParameterValue(self):
		res = (self.toLayer.getValue(),self.toLayerField.getValue()[0],self.fromTable.getValue(),self.fromTableField.getValue()[0],self.fromTableValue.getValue()[0])
		return res